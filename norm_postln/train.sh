...
#SBATCH --output=logs/norm_postln_%j.out
#SBATCH --error=logs/norm_postln_%j.err
...
OUTPUT_DIR="norm_postln/runs/${SLURM_JOB_ID}"
mkdir -p "$OUTPUT_DIR"

echo "Output directory: $(pwd)/$OUTPUT_DIR"
echo "=========================================="

python -u train.py --model-dir norm_postln --output-dir "$OUTPUT_DIR"
